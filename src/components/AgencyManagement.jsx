...
const AgencyManagement = () => {
    ...
    const [currentAgency, setCurrentAgency] = useState({ nom_agence: '', adresse: '', ville: '', telephone: '', email: '', rc: '', ice: '', is_active: true });
    ...
    const handleSaveAgency = async (e) => {
        ...
        try {
            ...
            setCurrentAgency({ nom_agence: '', adresse: '', ville: '', telephone: '', email: '', rc: '', ice: '', is_active: true });
        } catch (error) {
    ...
    const handleDelete = (id) => {
        messageBox.danger("Êtes-vous sûr de vouloir supprimer cette agence ?", "Supprimer l'agence", {
            onConfirm: async () => {
                try {
    ...
    return (
        <>
            <div className="flex justify-between items-end mb-8">
                ...
                <button 
                    onClick={() => { setIsEditing(false); setCurrentAgency({ nom_agence: '', adresse: '', ville: '', telephone: '', email: '', rc: '', ice: '', is_active: true }); setShowModal(true); }}
                                        ...
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-[10px] text-slate-500 uppercase font-semibold">ICE: {agency.ice || '-'}</p>
                                                        {agency.ville && <p className="text-[10px] text-slate-400 font-medium">{agency.ville}</p>}
                                            </div>
                                        </div>
                                    </td>
                                    <td className="px-6 py-5">
