...
const Marketplace = () => {
  ...
  return (
    <div className="bg-surface text-on-surface font-body min-h-screen">
      {/* Top Navigation Bar */}
      <nav className="bg-[#F8FAFC] dark:bg-slate-900 sticky top-0 z-50 shadow-sm">
        <div className="flex justify-between items-center w-full px-6 py-4 max-w-screen-2xl mx-auto">
          <div className="flex items-center gap-12">
            <span className="text-2xl font-bold tracking-tighter text-[#1D4ED8] dark:text-white font-manrope cursor-pointer" onClick={() => navigate('/')}>Kricar Marketplace</span>
            <div className="hidden md:flex items-center gap-8 font-manrope text-sm font-semibold tracking-tight">
              <a className="text-[#1D4ED8] dark:text-white border-b-2 border-[#1D4ED8] dark:border-blue-400 pb-1" href="#">Browse</a>
              <a className="text-slate-500 dark:text-slate-400 hover:text-[#1D4ED8] dark:hover:text-white transition-colors" href="#">Agencies</a>
              <a className="text-slate-500 dark:text-slate-400 hover:text-[#1D4ED8] dark:hover:text-white transition-colors" href="#">Insurance</a>
              <a className="text-slate-500 dark:text-slate-400 hover:text-[#1D4ED8] dark:hover:text-white transition-colors" href="#">Support</a>
            </div>
          </div>
          <div className="flex items-center gap-6">
            <div className="flex items-center gap-3 text-slate-500">
              <span className="material-symbols-outlined cursor-pointer hover:bg-[#F1F5F9] p-2 rounded-md transition-all">language</span>
              <span className="material-symbols-outlined cursor-pointer hover:bg-[#F1F5F9] p-2 rounded-md transition-all">help_outline</span>
            </div>
            <button 
              onClick={() => navigate('/login')}
              className="bg-[#1D4ED8] text-white px-5 py-2.5 rounded-lg text-sm font-semibold tracking-wide active:scale-95 duration-150 ease-in-out transition-all"
            >
              Sign In
            </button>
          </div>
        ...
        <section className="mb-12">
          ...
          <div className="relative z-20 max-w-5xl mx-auto bg-white p-4 rounded-xl shadow-xl flex flex-col md:flex-row gap-4 items-end">
            <div className="flex-1 w-full">
              ...
              <div className="bg-slate-50 flex items-center px-4 py-3 rounded-lg border-b-2 border-transparent focus-within:border-[#1D4ED8] transition-all">
            ...
            <button className="bg-[#1D4ED8] hover:bg-[#1E40AF] text-white px-8 py-3.5 rounded-lg font-bold transition-all h-[50px] flex items-center gap-2">
            ...
            <div className="sticky top-24 space-y-8">
              <div>
                <h3 className="font-manrope font-bold text-lg mb-6 flex items-center gap-2">
                  <span className="material-symbols-outlined text-[#1D4ED8]">filter_list</span>
                  Refine Results
                </h3>
                <div className="space-y-8">
                    ...
                    <div className="space-y-3">
                      {['Vantage Elite', 'Hertz Premium', 'Sixt Luxury'].map(agency => (
                        <label key={agency} className="flex items-center gap-3 cursor-pointer group">
                          <input type="checkbox" className="rounded-sm text-[#1D4ED8] focus:ring-[#1D4ED8] h-4 w-4 border-slate-300" />
                          <span className="text-sm font-medium group-hover:text-[#1D4ED8] transition-colors">{agency}</span>
                        </label>
                      ))}
                    </div>
                  </div>
                  ...
                  <div className="bg-slate-50 p-4 rounded-xl">
                    ...
                    <input 
                      className="w-full h-1.5 bg-slate-300 rounded-lg appearance-none cursor-pointer accent-[#1D4ED8]" 
                    ...
                    <div className="flex justify-between mt-2 text-xs font-bold text-slate-400">
                      <span>$50</span>
                      <span className="text-[#1D4ED8]">$1,000+</span>
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <div key={vehicle.id} className="group bg-white rounded-xl shadow-sm overflow-hidden transition-all duration-300 hover:translate-y-[-4px] hover:shadow-md">
                    <div className="relative h-64 overflow-hidden bg-slate-100">
                      ...
                      <div className="absolute top-4 right-4">
                        <span className="bg-white/80 backdrop-blur-md text-[10px] font-bold px-3 py-1 rounded-full uppercase tracking-widest text-[#1D4ED8]">
                          {vehicle.carburant}
                        </span>
                      </div>
                    </div>
                    <div className="p-6">
                      <div className="flex justify-between items-start mb-2">
                        ...
                        <div className="text-right">
                          <span className="text-2xl font-bold font-manrope text-[#1D4ED8]">${vehicle.prix_par_jour}</span>
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                          <div className="w-6 h-6 bg-[#1D4ED8]/10 rounded-full flex items-center justify-center">
                            <span className="material-symbols-outlined text-[#1D4ED8] text-[14px]" style={{fontVariationSettings: "'FILL' 1"}}>verified</span>
                          </div>
                          <span className="text-xs font-bold text-slate-500">{vehicle.agency_details?.name || 'Kricar Partner'}</span>
                        </div>
                        <button className="bg-[#1D4ED8] text-white px-6 py-2.5 rounded-lg text-sm font-bold hover:shadow-lg transition-all">Book Now</button>
                      </div>
                    </div>
                  </div>
                ))}
      ...
      <footer className="bg-slate-900 text-white mt-24">
        <div className="w-full py-12 px-8 flex flex-col md:flex-row justify-between items-center gap-6 max-w-screen-2xl mx-auto">
          <div className="flex flex-col gap-2">
            <span className="font-manrope font-bold text-white text-xl">Kricar Agency</span>
            <p className="text-xs tracking-wide text-slate-400">© 2026 Kricar Agency. All rights reserved.</p>
          </div>
